...
![Fase 02 — VMs e sistemas operacionais](imagens2/vmzabbix.png)
![Fase 02 — VMs e sistemas operacionais](imagens2/vmgrafana.png)
![Fase 02 — VMs e sistemas operacionais](imagens2/srv-linux.png)
...
![Fase 04 — Preparação Linux](imagens2/preparaçãozabbix.png)
![Fase 04 — Preparação Linux](imagens2/preparaçãografana.png)
![Fase 04 — Preparação Linux](imagens2/preparaçãosrv.png)
...
![Fase 06 — Diagnóstico manual e Wireshark](imagens2/arp1.png)
![Fase 06 — Diagnóstico manual e Wireshark](imagens2/icmp.png)
![Fase 06 — Diagnóstico manual e Wireshark](imagens2/dns.png)
![Fase 06 — Diagnóstico manual e Wireshark](imagens2/tcp.png)
![Fase 06 — Diagnóstico manual e Wireshark](imagens2/tlspng)
...
![Fase 07 — Zabbix Server](imagens2/zabbix1.png)
...
![Fase 08 — Hosts e Zabbix Agent 2](imagens2/agentezabbix.png)
